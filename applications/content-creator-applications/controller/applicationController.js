...
const approve = async (id) => {
  ...
  const html =
    '<p>Parabéns! Sua aplicação para se tornar um Criador de Conteúdo foi aprovada!</p> <p><a href="https://app-staging.educado.io/welcome">faça login aqui</a>.</p> <p>' +
    kindRegardsPT +
    "</p>";
...
const reject = async (id, reason) => {
  ...
  const html =
    "<p>Infelizmente, sua aplicação para se tornar um Criador de Conteúdo foi rejeitada.</p><p> Motivo:" +
    reason +
    '</p><p>Para tentar novamente, <a href="https://app-staging.educado.io/welcome"> clique aqui</a>.</p><p>' +
    kindRegardsPT +
    "</p>";
  console.log(id);
